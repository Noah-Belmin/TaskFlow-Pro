    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            {highPriorityTasks.length === 0 ? (
              <p className="text-sm text-slate-500 text-center py-8">No high priority tasks</p>
            ) : (
                ...
                {upcomingTasks.map((task) => (
                  <div
                    ...
                    className={`p-3 border rounded-lg hover:bg-slate-50 cursor-pointer transition-colors ${
                      ...
                      isDueSoon(task.dueDate) ? 'border-orange-300 bg-orange-50' : ''
                    }`}
                    onClick={() => onTaskSelect?.(task)}
                  >
                    <div className="flex items-start justify-between gap-2">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-slate-500">Latest updates to your tasks</p>
        </CardHeader>
        <CardContent>
